...
<div class="box meta">
        ...
        <div class="foundat">
            Defined in: <a href="../files/src_lib_base.coffee.html#l28"><code>src\lib\base.coffee:28</code></a>
        </div>
...
<div class="box intro">
    <p>Base class for the DocPad Events object
Extends the backbone.js events object
<a href="http://backbonejs.org/#Events">http://backbonejs.org/#Events</a></p>

</div>

    <div class="constructor">
        <h2>Constructor</h2>
<div id="method_Events" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/src_lib_base.coffee.html#l28"><code>src\lib\base.coffee:28</code></a>
        </p>
