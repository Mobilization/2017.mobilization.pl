...
<head>
    <meta charset="utf-8">
    <title>ElementsCollection</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>ElementsCollection Class</h1>
<div class="box meta">

        <div class="extends">
            Extends <a href="../classes/Collection.html" class="crosslink">Collection</a>
        </div>

        <div class="foundat">
            Defined in: <a href="../files/src_lib_collections_elements.coffee.html#l14"><code>src\lib\collections\elements.coffee:14</code></a>
        </div>
...
<div class="box intro">
    <p>Base class for the DocPad Elements Collection object
Extends the DocPad collection class
<a href="https://github.com/docpad/docpad/blob/master/src/lib/base.coffee#L72">https://github.com/docpad/docpad/blob/master/src/lib/base.coffee#L72</a>
Used as the base collection class for specific collection of file types.
In particular metadata, scripts and styles.</p>

</div>

    <div class="constructor">
        <h2>Constructor</h2>
<div id="method_ElementsCollection" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/src_lib_collections_elements.coffee.html#l14"><code>src\lib\collections\elements.coffee:14</code></a>
        </p>
...
<div id="method_toHTML" class="method item">
